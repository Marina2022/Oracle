...
const RealTimePrediction = () => {
  return (
    <div className="relative">
      ...
      <Card className="flex flex-col gap-0 items-center rounded-xl border absolute -top-18 sm:-top-4 -right-4 glassmorphism p-3 px-2 w-28 float-animation z-20 shadow-none">
