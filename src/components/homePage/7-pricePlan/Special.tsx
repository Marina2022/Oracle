    ...
    <Card className="glassmorphism p-8 text-center mb-12 border-secondary neon-glow">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Зарегистрируйтесь сейчас и получите доступ ко всем возможностям платформы абсолютно бесплатно на первые 3&nbsp;месяца. Без автопродления.
        </p>
        ...
        <Button className="px-6 bg-secondary text-secondary-foreground hover:bg-secondary/90 neon-glow">Получить бесплатный доступ</Button>
      </div>
    </Card>
  );
};
