    ...
    <footer className="container pt-16 pb-8">
      <div className="grid lg:grid-cols-6 gap-8 mb-12">
        ...
        <ul className="space-y-2">
          ...
          <li className="space-y-3">
            <Link href="#"
                  className="text-sm text-muted-foreground hover:text-primary transition-colors">Связаться с нами</Link>
          </li>
        ...
        <ul className="space-y-2">
          ...
          <li className="space-y-3">
            <Link href="#"
                  className="text-sm text-muted-foreground hover:text-primary transition-colors">Обработка персональных
              данных</Link>
          </li>
          <li className="space-y-3">
            <Link href="#"
                  className="text-sm text-muted-foreground hover:text-primary transition-colors">Политика cookies</Link>
          </li>
          <li className="space-y-3">
            <Link href="#"
